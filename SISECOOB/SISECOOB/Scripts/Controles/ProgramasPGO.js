    ...
    if (params != null) {
        $.ajax({
            ...
            success: function (data) {
                if (data.result == true) {
                    AlertSuccess('Se ha guardado el registro exitosamente.', 'Programas PGOs');
                    buscar();
                } else {
            ...
            error: function () {
                AlertError('No se pudo guardar el registro. Intente nuevamente.', 'Programas PGOs');
            }
        });
    }
}
...
function Editando() {
    ...
    if (params != null) {
        $.ajax({
            ...
            success: function (data) {
                if (data.result == true) {
                    AlertSuccess('Se ha Actualizado el registro exitosamente.', 'Programas PGOs');
                    buscar();
                } else {
...
function Elimina(id) {
    $.ajax({
        ...
        success: function (data) {
            if (data.result == true) {
                AlertSuccess('Se ha Eliminado el registro exitosamente.', 'Programas PGOs');
                buscar();
            } else {
                AlertError(data.message, 'Programas PGOs');
            }
        },
        error: function () {
            AlertError('No se pudo guardar el registro. Intente nuevamente.', 'Programas PGOs');
