...
function Nuevo() {
    $('#titulo').text('Nuevo SubPrograma');
    $.ajax({
        type: 'POST',
        url: '/SubProgramas/Formulario',
        data: { id: 0 },
        beforeSend: function () {
            Loading("Cargando");
        },
    ...
    if (params != null) {
        $.ajax({
            ...
            success: function (data) {
                if (data.result == true) {
                    AlertSuccess('Se ha guardado el registro exitosamente.', 'SubPrograma');
                    buscar();
                } else {
            ...
            error: function () {
                AlertError('No se pudo guardar el registro. Intente nuevamente.', 'SubPrograma');
            }
        });
    }
}
...
function Editando() {
    ...
    if (params != null) {
        $.ajax({
            ...
            success: function (data) {
                if (data.result == true) {
                    AlertSuccess('Se ha Actualizado el registro exitosamente.', 'SubPrograma');
                    buscar();
                } else {
                    AlertError(data.message, 'SubPrograma');
                }
...
function Elimina(id) {
    $.ajax({
        ...
        success: function (data) {
            if (data.result == true) {
                AlertSuccess('Se ha Eliminado el registro exitosamente.', 'SubPrograma');
                buscar();
            } else {
                AlertError(data.message, 'SubPrograma');
            }
