$(document).ready(function() { 
	...
	$("#skin-select #toggle").click(function() { 
		...
		if($(this).hasClass('active')) {
			...
			$('.wrap-fluid').css({"width":"auto","margin-left":"290px"});
			$('.navbar').css({"margin-left":"270px"});
			...
			$('.wrap-fluid').css({"width":"auto", "margin-left":"70px"});
		    ...
		    // Agregar estilo al logo geos para que se ajuste
			$('.logo-geos').addClass('mini');
