...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("Longitud maxima de caracteres {0}."),
		minlength: $.validator.format("Longitud minima de caracteres {0}."),
		rangelength: $.validator.format("El valor debe estar entre {0} y {1} caracteres."),
		range: $.validator.format("El valor debe estar entre {0} y {1}."),
		max: $.validator.format("El valor no debe ser mayor a {0}."),
		min: $.validator.format("El valor no debe ser menor de {0}.")
	},
